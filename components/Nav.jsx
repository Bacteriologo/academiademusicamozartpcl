    ...
    <nav style={{
      ...
      <div style={{
        ...
        <a href="#" style={{ display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
          <img src="uploads/logo.jpg" alt="Mozart" style={{ display: 'block', height: "135px", borderWidth: "0px", borderStyle: "solid", padding: "0px", margin: "0px", borderRadius: "0px", objectFit: "scale-down", width: "135px" }} />
        </a>
